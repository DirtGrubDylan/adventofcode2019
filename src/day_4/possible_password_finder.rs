...
mod test {
    ...
    fn test_number_of_double_digit_passwords_up_to() {
        ...
        let expected_4 = 91;
        let result_4 = possible_password_finder.number_of_double_digit_passwords_up_to(761);

        let expected_5 = 82;
        let result_5 = possible_password_finder.number_of_double_digit_passwords_up_to(557);
